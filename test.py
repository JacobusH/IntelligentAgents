...
onto = get_ontology("E:\\Homework\\Intelligent Agents\\PartPicker\\Shared3.owl").load()
obo = get_namespace("http://webprotege.stanford.edu/project/xpUFBIdmzwyCPpbfIg4hh")
# sync_reasoner()

### find all items with HasCPUSocket property
# test = get_subclasses_recur("Memory")
test = get_subclasses_onelevel("Memory")
tmp = 'tmp'
...
# onto.save("E:\\Homework\\Intelligent Agents\\PartPicker\\Shared3.owl")
